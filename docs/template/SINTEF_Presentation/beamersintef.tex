...
\verb|\footlinecolor{color}|
      ...
      \testcolor{sintefblue}, \testcolor{sintefyellow}, 
...
\testcolor{sintefblue}, \testcolor{sintefdarkgreen}, and 
...
{images/SINTEF_Logo_Sentrert_RGB}
\end{verbatim}
\end{block}
\end{column}
\begin{column}{0.3\textwidth}
...
\begin{chapter}[images/default]{sintefred}{Special Slides}
\begin{itemize}
\item Chapter slides
...
\item There are seven ``official'' colours: \testcolor{sintefblue}, 
...
\begin{sidepic}{images/default}{Side-Picture Slides}
\begin{itemize}
